function [output] = findFitness_Sfc_M2_maptorange(concentrations)
...
fitness(1) = exponential_Sfc_M2(dataG1);
fitness(2) = exponential_Sfc_M2(dataG2);
fitness(3) = exponential_Sfc_M2(dataG3);
